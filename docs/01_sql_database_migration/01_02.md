...
33. Congratulations! You have successfully establish the link between Tailspin's on-premises `ToyStore` database and SQL MI. In the next task, you will migrate the `ToyStore` database.
