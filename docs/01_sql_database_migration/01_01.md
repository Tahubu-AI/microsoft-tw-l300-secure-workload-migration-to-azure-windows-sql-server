...
1. In the Azure Portal, navigate to the Resource Group for the lab and select the `tailspin<uniqueid>-onprem-sql-vm` virtual machine from the list of resources.
