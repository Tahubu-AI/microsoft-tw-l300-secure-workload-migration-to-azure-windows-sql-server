...
5. For each of the values retrieved previously, that are market `NotRegistered`, run the following Azure CLI command. This will register the specified Resource provider.
