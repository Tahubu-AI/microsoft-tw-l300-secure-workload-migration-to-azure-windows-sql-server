...
1. Deploy the [ARM Template](https://github.com/tahubu-ai/microsoft-tw-l300-secure-workload-migration-to-azure-windows-sql-server/tree/main/Hands-on%20lab/resources/deployment) to Azure.
...
1. Open a browser using "InPrivate" or "Incognito" mode, and navigate to the ARM template: [ARM Template on GitHub](https://github.com/tahubu-ai/microsoft-tw-l300-secure-workload-migration-to-azure-windows-sql-server/tree/main/Hands-on%20lab/resources/deployment).
